...
const marqueeItems = ['ClassX', 'Tunify', 'SeizeFire', 'Lumina Fitness', 'WinDeck', 'DailyDash', 'Whether', 'Flutter', 'React', 'Firebase', 'Node.js', 'Full Stack'];

const projects = [
    { title: "ClassX",        category: "EdTech Platform",  tech: "Django · Python · HTML · CSS · JavaScript · SQLite",  images: ["/work/classx1.jpeg"],                                                                                                                                                                                                                    desc: "A premium, interactive classroom platform with smooth UX, real-time engagement, and production-ready deployment.",  github: "https://github.com/Satbhai444/classx", live: "http://darshansatbhai0801.pythonanywhere.com/home/" },
